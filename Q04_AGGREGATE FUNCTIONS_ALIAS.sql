...
INSERT INTO satis_raporu VALUES
(11, 'Laptop', 10, 5000.00, '2023-01-01');
...
SELECT COUNT(urun_adi) AS 1000_den_kucuk_urun_adedi
FROM satis_raporu
...
SELECT SUM(satis_miktari) AS Toplam_satis_miktari FROM satis_raporu ;
...
SELECT SUM(satis_miktari*birim_fiyati) AS Toplam_tutar
 FROM satis_raporu
...
SELECT SUM(satis_miktari*birim_fiyati) AS Toplam_Satis_Ocak
FROM satis_raporu
...
SELECT AVG(birim_fiyati) AS Ortalama_fiyat FROM satis_raporu ;
...
SELECT AVG(birim_fiyati) AS Ortalam_Fiyat
 FROM satis_raporu
...
SELECT MIN(birim_fiyati) AS Mın_Fiyat
 FROM satis_raporu;
