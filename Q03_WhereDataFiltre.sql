...
INSERT INTO kisiler () VALUES (1,'Ahmet', 'Yılmaz', 30, 'Ankara');
INSERT INTO kisiler () VALUES (2,'Mehmet', 'Kara', 25, 'İstanbul');
INSERT INTO kisiler () VALUES (3,'Ayşe', 'Kaya', 22, 'İzmir');
 ...
 */
 ...
 SELECT * FROM kisiler
 WHERE sehir = 'İstanbul' OR sehir = 'Ankara' OR sehir = 'İzmir';
 ...
 */
 ...
 SELECT * FROM kisiler
 WHERE NOT sehir IN ('Istanbul','Ankara','Izmir'); 
